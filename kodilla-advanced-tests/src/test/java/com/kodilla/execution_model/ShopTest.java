...
public class ShopTest {
    Shop shop = new Shop();
    Order drone = new Order(3999.99, LocalDate.of(2023, 1, 22), "Marcin");
    Order laptop = new Order(2500.00, LocalDate.of(2023, 2, 20), "Grzesiek");
    Order computer = new Order(5500.00, LocalDate.of(2023, 4, 10), "Dawid");
    Order speakers = new Order(255.00, LocalDate.of(2023, 4, 13), "Michal");
    Order desk = new Order(800.00, LocalDate.of(2023, 4, 15), "Kasia");
    Order chair = new Order(450.00, LocalDate.of(2023, 5, 2), "Zaneta");
    Order tv = new Order(3000, LocalDate.of(2023, 12, 30), "Amelia");
    ...
    public void shouldReturnCorrectDates() {
        int result = shop.getOrdersByDate(LocalDate.of(2023,4,1), LocalDate.of(2023,4,29)).size();
